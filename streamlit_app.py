...
st.markdown("<h1 style='text-align: center; color: black;'>机器学习预测</h1>", unsafe_allow_html=True)
st.markdown("<h1 style='text-align: center; color: black;'>Machine Learning Prediction</h1>", unsafe_allow_html=True)
